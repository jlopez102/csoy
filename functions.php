...
if ( ! function_exists( 'tusky_setup' ) ) :
	...
	function tusky_setup() {
		...
		/***** ADD IMAGES SIZES ******/
		add_image_size( 'gallery-thumb',600,9999 ); 
...
function tusky_scripts() {
	...
	wp_enqueue_script( 'tusky-main', get_template_directory_uri() . '/js/script.js', array(), _S_VERSION, true );
	wp_enqueue_script( 'tusky-slider', get_template_directory_uri() . '/js/slider.js', array(), _S_VERSION, true );
